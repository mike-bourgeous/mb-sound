...
if ENV['DEBUG'] == '1'
  ...
  File.write('/tmp/sinewave_before.dot', output_chain.graphviz)
  `dot -Tpng /tmp/sinewave_before.dot -o /tmp/sinewave_before.png`
end
...
begin
  ...
  if ENV['DEBUG'] == '1'
    ...
    File.write('/tmp/sinewave_after.dot', output_chain.graphviz)
    `dot -Tpng /tmp/sinewave_after.dot -o /tmp/sinewave_after.png`
  end
end
