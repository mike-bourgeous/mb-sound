...
# Synth
graph = (MB::Sound.midi.gate * (porta.tone.at(2).wavetable(wavetable: {wavetable: 'sounds/drums.flac', slices: 30, ratio: 2}, number: nzlfo).forever * 0.5 + porta.tone.triangle)).filter(:lowpass, cutoff: 5000, quality: 0.25).softclip
