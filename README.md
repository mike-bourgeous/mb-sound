...
Note that any included sounds or MIDI sequences, and the music generated by the
demo song programs under `bin/songs`, are not covered by the software license.
They may only be used in connection with this specific software project,
mb-sound, for testing of and experimentation with the mb-sound project itself.
