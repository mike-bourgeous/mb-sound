RSpec.describe(MB::Sound::GraphNode::MultitapDelay) do
  ...
  it 'can delay multiple taps by differing constant amounts' do
    dly = MB::Sound::GraphNode::MultitapDelay.new(-2.constant, 2.5, 4.5, 0, rate: 1)
  ...
  it 'can process complex data' do
    dly = MB::Sound::GraphNode::MultitapDelay.new((1+1i).constant, 0.5, rate: 10)
    tap = dly.taps[0]
  ...
  it 'can delay by a variable amount' do
    ...
    tap = 1.hz.square.forever.at(1).at_rate(2).multitap(d.clip_rate(1, rate: 1), rate: 1)[0]
